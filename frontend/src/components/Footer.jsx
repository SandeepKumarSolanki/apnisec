...
function Footer() {
    return (
        <footer className="bg-dark-700 border-t border-dark-border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-400 mb-4 max-w-md">
                            Your trusted partner in cybersecurity. We provide comprehensive security solutions
                            to protect your digital assets from evolving threats.
                        </p>
                        <div className="flex gap-4">
                            <a href="#" className="w-10 h-10 bg-dark-600 rounded-lg flex items-center justify-center text-gray-400 hover:text-primary-500 hover:bg-dark-500 transition-all">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="text-gray-400 hover:text-primary-500 transition-colors">Services</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-primary-500 transition-colors">Case Studies</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li className="text-gray-400">
                                <span className="text-primary-500">Email:</span> contact@apnisec.com
                            </li>
                            <li className="text-gray-400">
                                <span className="text-primary-500">Phone:</span> +91 98765 43210
                            </li>
                            <li className="text-gray-400">
                                <span className="text-primary-500">Address:</span> Cyber City, Tech Hub, India
                            </li>
                        </ul>
                    </div>
                </div>
